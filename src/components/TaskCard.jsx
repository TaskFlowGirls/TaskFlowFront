...
const handleSaveData = (dateSpecifique) => {
    ...
    >
        ...
        <div className="task-details" style={{fontSize: '0.75rem', margin: '10px 0'}}>
            ...
            {/* ICI : Le changement de date déclenche l'enregistrement automatique */}
    ...
    onChange={(e) => {
        ...
        console.log("Date modifiée, envoi vers BDD :", nouvelleDate);
        
        // 1. Mise à jour visuelle immédiate
        setDateFin(nouvelleDate);
        
        // 2. Appel de la fonction de sauvegarde via les props
        onUpdate(task.id, {
            statutTaches: task.statut,
            tempsReelTaches: task.temps_reel,
            dateFinTaches: nouvelleDate // On envoie la date au parent
        });
    }} 
